...
public class SpongePlayerInventory extends SpongeInventory implements PlayerInventory {
    ...
    public ItemStack getHelmet() {
        org.spongepowered.api.item.inventory.ItemStack helmet = playerInventory.getEquipment().peek(EquipmentTypes.HEADWEAR).orElse(null);
    ...
    public ItemStack getChestplate() {
        org.spongepowered.api.item.inventory.ItemStack chestplate = playerInventory.getEquipment().peek(EquipmentTypes.CHESTPLATE).orElse(null);
    ...
    public ItemStack getLeggings() {
        org.spongepowered.api.item.inventory.ItemStack leggings = playerInventory.getEquipment().peek(EquipmentTypes.LEGGINGS).orElse(null);
    ...
    public ItemStack getBoots() {
        org.spongepowered.api.item.inventory.ItemStack boots = playerInventory.getEquipment().peek(EquipmentTypes.BOOTS).orElse(null);
    ...
    public ItemStack getItemInOffHand() {
        org.spongepowered.api.item.inventory.ItemStack offHand = playerInventory.getEquipment().peek(EquipmentTypes.OFF_HAND).orElse(null);
