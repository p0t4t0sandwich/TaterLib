 ...
 */
package dev.neuralnexus.taterlib.v1_13_2.bukkit.entity.player;
...
import dev.neuralnexus.taterlib.v1_13_2.bukkit.item.inventory.BukkitPlayerInventory;
...
public class BukkitPlayer extends BukkitLivingEntity implements Player, ServerPlayer {
    ...
    public void sendPacket(final @NonNull CustomPacketPayload payload) {
        ...
        ((StreamCodec<FriendlyByteBuf, CustomPacketPayload>) payload.type().codec())
                .encode(data, payload);
        this.player.sendPluginMessage((Plugin) TaterLib.mod(), payload.type().id(), data.array());
    }
