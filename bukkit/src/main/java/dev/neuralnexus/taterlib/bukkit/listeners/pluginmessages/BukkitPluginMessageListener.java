...
import dev.neuralnexus.taterlib.bukkit.event.api.pluginmessages.BukkitPluginMessageEvent;
...
public class BukkitPluginMessageListener implements PluginMessageListener {
    ...
    public void onPluginMessageReceived(@NotNull String channel, @NotNull Player player, byte[] bytes) {
        ...
        PluginMessageEvents.PLAYER_PLUGIN_MESSAGE.invoke(new BukkitPluginMessageEvent.Player(channel, bytes, player));
    }
}
