...
import dev.neuralnexus.taterlib.v1_7_10.bukkit.event.network.BukkitRegisterPluginMessagesEvent;
import dev.neuralnexus.taterlib.v1_7_10.bukkit.event.server.BukkitServerStartedEvent;
import dev.neuralnexus.taterlib.v1_7_10.bukkit.event.server.BukkitServerStartingEvent;
import dev.neuralnexus.taterlib.v1_7_10.bukkit.event.server.BukkitServerStoppedEvent;
import dev.neuralnexus.taterlib.v1_7_10.bukkit.event.server.BukkitServerStoppingEvent;
...
public class BukkitTaterLibPlugin implements TaterLibPlugin {
    ...
    public void onInit(Object plugin, Object server, Object logger) {
        ...
        TaterAPI api = TaterAPIProvider.get(Platform.BUKKIT);
