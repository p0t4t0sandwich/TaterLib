 ...
 */
public class FabricBlockEvent implements BlockBreakEvent {
    ...
    public FabricBlockEvent(World world, BlockPos pos, BlockState state, PlayerEntity player, CallbackInfo ci) {
        this.world = world;
        this.pos = pos;
        this.state = state;
        this.player = player;
