...
package dev.neuralnexus.taterlib.v1_14_4.vanilla.entity.player;
...
import dev.neuralnexus.taterlib.v1_14_4.vanilla.entity.VanillaLivingEntity;
...
public class VanillaPlayer extends VanillaLivingEntity implements Player, ServerPlayer {
    ...
    public void setSpawn(Location location, boolean forced) {
        player.setRespawnPosition(new BlockPos(location.x(), location.y(), location.z()), forced);
    }
