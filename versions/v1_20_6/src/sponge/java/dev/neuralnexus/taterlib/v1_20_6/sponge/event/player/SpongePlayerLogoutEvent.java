 ...
 */
package dev.neuralnexus.taterlib.v1_20_6.sponge.event.player;
...
public class SpongePlayerLogoutEvent implements PlayerLogoutEvent {
    private final ServerSideConnectionEvent.Leave event;
    private String logoutMessage = "";

    public SpongePlayerLogoutEvent(ServerSideConnectionEvent.Leave event) {
        this.event = event;
    }
