 ...
 */
package dev.neuralnexus.taterlib.mixin.v1_21_4.fabric.core.world.entity.player;
...
@AConstraint(
        ...
        version = @Versions(min = MinecraftVersion.V21_4))
@Mixin(Player.class)
public abstract class PlayerMixin implements PlayerBridge {
    ...
    public void bridge$sendMessage(String message) {
        if ((Object) this instanceof ServerPlayer player) {
            player.sendSystemMessage(VanillaUtils.component.apply(message));
        }
    }
}
