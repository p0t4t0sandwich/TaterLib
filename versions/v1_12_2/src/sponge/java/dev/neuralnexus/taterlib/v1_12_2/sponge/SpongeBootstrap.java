                                ...
                                .orElseThrow(
                                        () ->
                                                new IllegalStateException(
                                                        "ABSORPTION key is not present"));
        SpongeFactories.setAbsorptionAmount =
                (entity, amount) -> entity.getHealthData().set(Keys.ABSORPTION, amount);

        SpongeFactories.keepInventory = DestructEntityEvent.Death::getKeepInventory;
        SpongeFactories.setKeepInventory = DestructEntityEvent.Death::setKeepInventory;
    }
}
