 ...
 */
package dev.neuralnexus.taterlib.v1_10_2.vanilla.entity.player;
...
import dev.neuralnexus.taterlib.v1_10_2.vanilla.entity.WrappedLivingEntity;
import dev.neuralnexus.taterlib.v1_10_2.vanilla.item.inventory.WrappedPlayerInventory;
...
public class WrappedPlayer extends WrappedLivingEntity implements Player, ServerPlayer {
    ...
    public void setGameMode(GameMode gameMode) {
        ...
        this.player.setGameMode((WorldSettings.getGameMode(gameMode.id())));
    }
}
