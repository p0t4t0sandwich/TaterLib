 ...
 */
package dev.neuralnexus.taterlib.mixin.v1_10_2.forge.core.world;
...
import dev.neuralnexus.taterlib.v1_10_2.vanilla.entity.WrappedEntity;
...
public abstract class WorldMixin implements WorldBridge {
    ...
    public ResourceKey bridge$dimension() {
        return ResourceKey.of(this.dimension.getType().getName().replace(" ", "_").toLowerCase());
    }
    ...
    public List<Entity> bridge$entities(Entity entity, double radius, Predicate<Entity> predicate) {
        ...
        return this.shadow$getEntities(
                        mcEntity,
                        mcEntity.getCollisionShape().expand(radius),
