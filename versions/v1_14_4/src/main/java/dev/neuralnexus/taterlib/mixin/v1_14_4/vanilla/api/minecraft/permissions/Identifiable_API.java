package dev.neuralnexus.taterlib.mixin.v1_14_4.vanilla.api.minecraft.permissions;
...
@Implements(
        @Interface(iface = Identifiable.class, prefix = "identifiable$", remap = Interface.Remap.NONE))
