...
/**
 * Bukkit metrics adapter for Project-Poseidon b1.7.3 <br>
 * Utilizes this fix: <a
 * href="https://github.com/retromcorg/JVillage/blob/535b75f50835a724b6376f0271a93f03b798566c/src/main/java/com/johnymuffin/jvillage/beta/tasks/Metrics.java">JVillage</a>
 * <b>Note from p0t4t0sandwich: I need to look into how to stop google-java-format from formatting
...
public class BukkitBetaMetricsAdapter {
    ...
    public static class Metrics {
        ...
        //             * @param appendServiceDataConsumer A consumer that receives a {@code
        // JsonObjectBuilder}
        //             *     and appends all service-specific data.
        //             * @param submitTaskConsumer A consumer that takes a runnable with the submit
        // task. This
        //             *     can be used to delegate the data collection to a another thread to
        // prevent errors
        ...
        //             * @param logResponseStatusText Whether or not the response status text should
        // be
        //             *     logged.
        //             */
        //            public MetricsBase(
        ...
        //                // We want delayed tasks (non-periodic) that will execute in the future to
        // be
        ...
        //                checkRelocation();
        //                if (enabled) {
        //                    // WARNING: Removing the option to opt-out will get your plugin banned
        // from
        //                    // bStats
        //                    startSubmitting();
        //                }
        ...
        //                // bStats backend. To circumvent this problem, we introduce some
        // randomness into
        //                // the initial and second delay.
        //                // WARNING: You must not modify and part of this Metrics class, including
        // the
        //                // submit delay or frequency!
        //                // WARNING: Modifying this code will get your plugin banned on bStats.
        // Just
        //                // don't do it!
        ...
        //                                if (logErrors) {
        //                                    errorLogger.accept("Could not submit bStats metrics
        // data", e);
        //                                }
        //                            }
        //                        });
        ...
        //                    infoLogger.accept("Sent data to bStats and received response: " +
        // builder);
        //                }
        //            }
        //
        ...
        // 'g', 'e'
        //                                    });
        //                    // We want to make sure no one just copy & pastes the example and uses
        // the wrong
        //                    // package names
        //                    if
        ...
        //                        valueBuilder.appendField(valueEntry.getKey(),
        // valueEntry.getValue());
        //                        allSkipped = false;
        //                    }
        //                    if (!allSkipped) {
        //                        reallyAllSkipped = false;
        //                        valuesBuilder.appendField(entryValues.getKey(),
        // valueBuilder.build());
        //                    }
        //                }
        //                if (reallyAllSkipped) {
        ...
        //            }
        //
        //            protected abstract JsonObjectBuilder.JsonObject getChartData() throws
        // Exception;
        //        }
        //
        ...
        //         *
        //         * <p>While this class is neither feature-rich nor the most performant one, it's
        // sufficient
        ...
        //             *
        //             * <p>This class only exists to make methods of the {@link JsonObjectBuilder}
        // type-safe
