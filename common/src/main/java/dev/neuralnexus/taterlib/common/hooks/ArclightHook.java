...
public class ArclightHook {
    ...
    /**
     * Register a Forge event from Bukkit
     * Don't really need this atm due to TaterLib's event system, but a maybe for the future
     * Would need to reflect to grab the Forge event bus, or split off Arclight into its own submodule
     */
//    public static void registerForgeEvent(Plugin plugin, IEventBus eventBus, Object target)

    /**
     * Get the {@link TickingTracker}
     * return The {@link TickingTracker}
     */
