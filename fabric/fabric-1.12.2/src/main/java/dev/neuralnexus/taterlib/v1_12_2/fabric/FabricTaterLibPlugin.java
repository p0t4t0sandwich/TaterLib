...
import dev.neuralnexus.taterlib.v1_12_2.fabric.event.block.FabricBlockBreakEvent;
import dev.neuralnexus.taterlib.v1_12_2.fabric.event.command.FabricCommandRegisterEvent;
import dev.neuralnexus.taterlib.v1_12_2.fabric.event.entity.FabricEntityDamageEvent;
...
import dev.neuralnexus.taterlib.v1_12_2.fabric.event.server.FabricServerStartedEvent;
import dev.neuralnexus.taterlib.v1_12_2.fabric.event.server.FabricServerStartingEvent;
import dev.neuralnexus.taterlib.v1_12_2.fabric.event.server.FabricServerStoppedEvent;
import dev.neuralnexus.taterlib.v1_12_2.fabric.event.server.FabricServerStoppingEvent;
import dev.neuralnexus.taterlib.v1_12_2.fabric.hooks.permissions.FabricPermissionsHook;
import dev.neuralnexus.taterlib.v1_12_2.fabric.server.FabricServer;
