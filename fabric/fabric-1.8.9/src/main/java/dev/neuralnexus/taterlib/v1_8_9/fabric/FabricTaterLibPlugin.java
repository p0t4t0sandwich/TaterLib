...
import dev.neuralnexus.taterlib.v1_8_9.fabric.event.block.FabricBlockBreakEvent;
import dev.neuralnexus.taterlib.v1_8_9.fabric.event.command.FabricCommandRegisterEvent;
import dev.neuralnexus.taterlib.v1_8_9.fabric.event.entity.FabricEntityDamageEvent;
import dev.neuralnexus.taterlib.v1_8_9.fabric.event.entity.FabricEntityDeathEvent;
import dev.neuralnexus.taterlib.v1_8_9.fabric.event.entity.FabricEntitySpawnEvent;
import dev.neuralnexus.taterlib.v1_8_9.fabric.event.player.*;
import dev.neuralnexus.taterlib.v1_8_9.fabric.event.server.FabricServerStartedEvent;
import dev.neuralnexus.taterlib.v1_8_9.fabric.event.server.FabricServerStartingEvent;
