...
tasks.named<ShadowJar>("shadowJar") {
    ...
    relocate("dev.neuralnexus.taterlib.mixin.v1_17.vanilla", "dev.neuralnexus.taterlib.mixin.v1_17.vanilla.fabric")
    relocate("dev.neuralnexus.taterlib.v1_17.vanilla", "dev.neuralnexus.taterlib.v1_17.vanilla.fabric")
}
