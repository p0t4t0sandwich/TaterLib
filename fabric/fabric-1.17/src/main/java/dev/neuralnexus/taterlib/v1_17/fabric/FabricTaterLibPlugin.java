...
import dev.neuralnexus.taterlib.v1_17.fabric.event.api.FabricBlockEvents;
import dev.neuralnexus.taterlib.v1_17.fabric.event.api.FabricEntityEvents;
import dev.neuralnexus.taterlib.v1_17.fabric.event.api.FabricPlayerEvents;
import dev.neuralnexus.taterlib.v1_17.fabric.event.block.FabricBlockBreakEvent;
import dev.neuralnexus.taterlib.v1_17.fabric.event.command.FabricBrigadierCommandRegisterEvent;
import dev.neuralnexus.taterlib.v1_17.fabric.event.command.FabricCommandRegisterEvent;
import dev.neuralnexus.taterlib.v1_17.fabric.event.entity.FabricEntityDamageEvent;
import dev.neuralnexus.taterlib.v1_17.fabric.event.entity.FabricEntityDeathEvent;
import dev.neuralnexus.taterlib.v1_17.fabric.event.entity.FabricEntitySpawnEvent;
import dev.neuralnexus.taterlib.v1_17.fabric.event.player.*;
import dev.neuralnexus.taterlib.v1_17.fabric.event.server.FabricServerStartedEvent;
import dev.neuralnexus.taterlib.v1_17.fabric.event.server.FabricServerStartingEvent;
import dev.neuralnexus.taterlib.v1_17.fabric.event.server.FabricServerStoppedEvent;
import dev.neuralnexus.taterlib.v1_17.fabric.event.server.FabricServerStoppingEvent;
