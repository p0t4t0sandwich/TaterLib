...
package dev.neuralnexus.taterlib.v1_14.fabric.world;
...
public class FabricWorld implements World {
    ...
    public ResourceKey dimension() {
        return (ResourceKey) (Object) Registry.DIMENSION.getId(level.dimension.getType());
    }
    ...
    public List<Entity> entities(
        ...
        return level
                .getEntities(
                        ...
                        new BoundingBox(pos1.x(), pos1.y(), pos1.z(), pos2.x(), pos2.y(), pos2.z()),
                        e -> predicate.test(new FabricEntity(e)))
                .stream()
                .map(FabricEntity::new)
                .collect(Collectors.toList());
