...
package dev.neuralnexus.taterlib.v1_8.sponge.listeners.entity;

import dev.neuralnexus.taterlib.event.api.EntityEvents;
import dev.neuralnexus.taterlib.v1_8.sponge.event.entity.SpongeEntityDamageEvent;
import dev.neuralnexus.taterlib.v1_8.sponge.event.entity.SpongeEntityDeathEvent;
import dev.neuralnexus.taterlib.v1_8.sponge.event.entity.SpongeEntitySpawnEvent;
