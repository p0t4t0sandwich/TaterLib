...
public class ForgePlayerListener {
    ...
    public void onPlayerAdvancement(AdvancementEvent event) {
        ...
        PlayerListener.onPlayerAdvancement(player, advancement.getParent().getDisplay().getTitle().getFormattedText());
        ...
        if (display != null && display.shouldAnnounceToChat() && progress.isDone()) {
            PlayerListener.onPlayerAdvancementFinished(player, advancement.getDisplay().getTitle().getFormattedText());
        }
    }
    ...
    public void onPlayerDeath(LivingDeathEvent event) {
        ...
        if (entity instanceof EntityPlayer) {
            PlayerListener.onPlayerDeath(new ForgePlayer((EntityPlayer) entity), event.getSource().getDeathMessage(entity).getFormattedText());
        }
    }
    ...
    public void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        PlayerListener.onPlayerLogin(new ForgePlayer(event.player));
    }
    ...
    public void onPlayerLogout(PlayerEvent.PlayerLoggedOutEvent event) {
        // Pass TaterPlayer to helper function
        PlayerListener.onPlayerLogout(new ForgePlayer(event.player));
    }
    ...
    public void onPlayerRespawn(PlayerEvent.PlayerRespawnEvent event) {
        PlayerListener.onPlayerRespawn(new ForgePlayer(event.player));
    }
}
