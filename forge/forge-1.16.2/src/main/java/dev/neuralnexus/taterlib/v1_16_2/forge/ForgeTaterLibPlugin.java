...
import dev.neuralnexus.taterlib.v1_16.vanilla.event.block.VanillaPlayerBlockBreakEvent;
...
import dev.neuralnexus.taterlib.v1_16.vanilla.event.player.VanillaPlayerAdvancementEvent;
import dev.neuralnexus.taterlib.v1_16.vanilla.event.player.VanillaPlayerDeathEvent;
                    ...
                    event -> {
                        CommandEvents.REGISTER_COMMAND.invoke(
                                new VanillaCommandRegisterEvent(
                                        event.getDispatcher(), event.getEnvironment()));
