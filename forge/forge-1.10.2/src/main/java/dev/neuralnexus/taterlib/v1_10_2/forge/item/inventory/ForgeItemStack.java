 ...
 */
package dev.neuralnexus.taterlib.v1_10_2.forge.item.inventory;
...
public class ForgeItemStack implements ItemStack, Wrapped<net.minecraft.item.ItemStack> {
    ...
    public void setUnbreakable(boolean unbreakable) {
        Objects.requireNonNull(this.itemStack.getTagCompound());
        this.itemStack.getTagCompound().getCompoundTag("Unbreakable").setBoolean("Unbreakable", unbreakable);
    }
}
