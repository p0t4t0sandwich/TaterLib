...
public class ForgePlayer extends ForgeLivingEntity implements Player {
  ...
  public void kick(String message) {
    ((EntityPlayerMP) player).playerNetServerHandler.onDisconnect(new ChatComponentText(message));
  }
  ...
  public GameMode gameMode() {
    ...
    try {
        ...
        Object gameType = itemInWorldManager.getClass().getMethod("func_73081_b").invoke(itemInWorldManager);
        return GameMode.fromName(gameType.getClass().getMethod("func_77149_b").invoke(gameType).toString());
    } catch (Exception e) {
