package dev.neuralnexus.taterlib.v1_8_9.forge.event.block;

import dev.neuralnexus.taterlib.block.Block;
import dev.neuralnexus.taterlib.event.block.BlockEvent;
import dev.neuralnexus.taterlib.v1_8_9.forge.block.ForgeBlock;
...
public class ForgeBlockEvent implements BlockEvent {
    ...
    @Override
    public Block block() {
        return new ForgeBlock(this.event.pos, this.event.state.getBlock());
    }
}
