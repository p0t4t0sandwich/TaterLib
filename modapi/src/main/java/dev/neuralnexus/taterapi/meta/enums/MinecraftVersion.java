...
public enum MinecraftVersion {
    ...
    V21_5(MinecraftVersions.V21_5);

    private final dev.neuralnexus.taterapi.meta.MinecraftVersion ref;

    MinecraftVersion(dev.neuralnexus.taterapi.meta.MinecraftVersion ref) {
        this.ref = ref;
    }
     ...
     */
    public dev.neuralnexus.taterapi.meta.MinecraftVersion ref() {
        return ref;
    }
}
