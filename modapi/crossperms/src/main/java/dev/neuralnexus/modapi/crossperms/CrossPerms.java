...
public class CrossPerms {
    ...
    public void setup(Object server) {
        ...
        var minecraftServer = MappingEntry.builder("MinecraftServer")
                .official(mcString)
                .mojang(mcString)
                .searge(mcString)
                .searge("net.minecraft.src.C_4977_", MinecraftVersions.V17, MinecraftVersions.V19_4)
        ...
        var minecraftServer_getPlayerList = MappingEntry.builder("getPlayerList")
                .parentEntry("MinecraftServer")
                .mojang("getPlayerList")
                .searge("m_6846_")
                .legacySearge("func_184103_al", MinecraftVersions.V9, MinecraftVersions.V16_5)
                ...
                .mcp("getConfigurationManager", MinecraftVersions.V7, MinecraftVersions.V8_9)
        ...
        // PlayerList
        var playerList = MappingEntry.builder("PlayerList")
                ...
                .legacySearge("net.minecraft.server.management.ServerConfigurationManager", MinecraftVersions.V7, MinecraftVersions.V8_9)
                .mcp("net.minecraft.server.management.ServerConfigurationManager", MinecraftVersions.V7, MinecraftVersions.V8_9)
        ...
        var playerList_getPlayers = MappingEntry.builder("getPlayers")
        ...
        var playerList_playerEntityList = MappingEntry.builder("players")
                .parentEntry("PlayerList")
        ...
        var playerList_isOp = MappingEntry.builder("isOp")
                .parentEntry("PlayerList")
                .mojang("isOp")
                .searge("m_11303_")
        ...
        store.registerClass(entity)
                .registerMethod(entity_hasPermissions);
        ...
        // -----------------------------------------------------------------------------------------------
        var commandSender = MappingEntry.builder("CommandSender")
        ...
        var commandSender_getCommandSenderEntity = MappingEntry.builder("getCommandSenderEntity")
