...
tasks.register<ShadowJar>("relocateFabricJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/modapi/briggen/mixin/v1_19_4/vanilla/**")
    }
...
tasks.register<ShadowJar>("relocateForgeJar") {
    ...
    relocate("dev.neuralnexus.modapi.briggen.v1_19_4.vanilla", "dev.neuralnexus.modapi.briggen.v1_19_4.searge")
