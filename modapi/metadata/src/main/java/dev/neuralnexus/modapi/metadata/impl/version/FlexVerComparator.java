...
/**
 * IGNORE THE ABOVE LICENCE HEADER, IT IS NOT CORRECT <br>
 * TODO: Exclude this file from the licence header check <br>
 * <br>
 * To the extent possible under law, the author has dedicated all copyright and related and
 * neighboring rights to this software to the public domain worldwide. This software is distributed
 * without any warranty. <br>
 * See <a
 * href="http://creativecommons.org/publicdomain/zero/1.0/">http://creativecommons.org/publicdomain/zero/1.0/</a>
 * <br>
 * <br>
 * <a
 ...
 * versions with differing formats will likely produce nonsensical results (garbage in, garbage
 * out), but best effort is made to correct for basic structural changes, and versions of differing
 * length will be parsed in a logical fashion.
 */
public class FlexVerComparator {
     ...
     * @return {@code 0} if the two versions are equal, a negative number if {@code a < b}, or a
     *     positive number if {@code a > b}
     */
    ...
    private static final VersionComponent NULL =
            new VersionComponent(new int[0]) {
                @Override
